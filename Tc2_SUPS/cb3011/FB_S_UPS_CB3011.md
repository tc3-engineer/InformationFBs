...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_S_UPS_CB3011.TcPOU`](../examples/P_Demo_FB_S_UPS_CB3011.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_FB_S_UPS_CB3011.TcPOU`](../examples/P_Demo_FB_S_UPS_CB3011.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
>
