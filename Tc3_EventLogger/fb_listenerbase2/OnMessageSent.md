...
| Status | `verified` |
| Example | [`examples/P_Demo_OnMessageSent.xml`](../examples/P_Demo_OnMessageSent.xml) |
...
> 配套可导入文件：[`examples/P_Demo_OnMessageSent.xml`](../examples/P_Demo_OnMessageSent.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
