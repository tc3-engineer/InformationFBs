...
| Status | `verified` |
| Example | [`examples/P_Demo_IOF_SER_IDN_Write.xml`](../examples/P_Demo_IOF_SER_IDN_Write.xml) |
...
> 配套可导入文件：[`examples/P_Demo_IOF_SER_IDN_Write.xml`](../examples/P_Demo_IOF_SER_IDN_Write.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
