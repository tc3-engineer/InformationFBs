...
| Status | `verified` |
| Example | [`examples/P_Demo_PLC_Stop.xml`](../examples/P_Demo_PLC_Stop.xml) |
...
> 配套可导入文件：[`examples/P_Demo_PLC_Stop.xml`](../examples/P_Demo_PLC_Stop.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
