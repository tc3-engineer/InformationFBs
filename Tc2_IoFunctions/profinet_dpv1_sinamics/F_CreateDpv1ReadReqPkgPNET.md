...
| Status | `verified` |
| Example | [`examples/P_Demo_F_CreateDpv1ReadReqPkgPNET.xml`](../examples/P_Demo_F_CreateDpv1ReadReqPkgPNET.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_CreateDpv1ReadReqPkgPNET.xml`](../examples/P_Demo_F_CreateDpv1ReadReqPkgPNET.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
