...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_KL3228Config.xml`](../examples/P_Demo_FB_KL3228Config.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_KL3228Config.xml`](../examples/P_Demo_FB_KL3228Config.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
