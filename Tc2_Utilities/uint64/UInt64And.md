...
| Verified | 2026-05-10 ✅ |
| Status | `verified` |
| Example | [`examples/P_Demo_UInt64And.xml`](../examples/P_Demo_UInt64And.xml) |
...
> 配套可导入文件：[`examples/P_Demo_UInt64And.xml`](../examples/P_Demo_UInt64And.xml)
>
...
a := ULARGE_INTEGER(16#FFFFFFFF, 16#0); b := ULARGE_INTEGER(16#0, 16#FFFFFFFF);
IF bRun THEN
    rResult := UInt64And(a, b);
    bRun := FALSE;
END_IF;
```
