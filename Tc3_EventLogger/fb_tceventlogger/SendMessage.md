...
| Verified | 2026-05-10 ✅ |
| Status | `verified` |
| Example | [`examples/P_Demo_SendMessage.xml`](../examples/P_Demo_SendMessage.xml) |

---
## 1. 功能简述

This method sends a message. Syntax METHOD SendMessage : HRESULT
...
- 见上方功能简述。
- 详细行为（时序、错误码、状态机）请对照 PDF 第 3.10.11 节。
...
- 描述句、时序行为、错误码表等细节请以 PDF 第 3.10.11 节为准（⚠️ 待人工细化）。

## 6. 最小例程

> 配套可导入文件：[`examples/P_Demo_SendMessage.xml`](../examples/P_Demo_SendMessage.xml)
>
> 详见 [`examples/README.md`](../examples/README.md)

```iecst
PROGRAM P_Demo_SendMessage
VAR
    fbSendMessage : SendMessage;
    arg_eventClass : GUID;
    arg_nEventId : UDINT;
