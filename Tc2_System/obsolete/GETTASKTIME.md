...
| Example | [`examples/P_Demo_GETTASKTIME.xml`](../examples/P_Demo_GETTASKTIME.xml) |
...
> 配套可导入文件：[`examples/P_Demo_GETTASKTIME.xml`](../examples/P_Demo_GETTASKTIME.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
