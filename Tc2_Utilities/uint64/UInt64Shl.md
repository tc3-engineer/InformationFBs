...
| Verified | 2026-05-10 ✅ |
| Status | `verified` |
| Example | [`examples/P_Demo_UInt64Shl.xml`](../examples/P_Demo_UInt64Shl.xml) |

---
## 1. 功能简述

**按位左移（shift left）**：高位丢弃，低位补 0。
...
> 配套可导入文件：[`examples/P_Demo_UInt64Shl.xml`](../examples/P_Demo_UInt64Shl.xml)
>
