...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_SetLedColor_BAPI.TcPOU`](../examples/P_Demo_FB_SetLedColor_BAPI.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_FB_SetLedColor_BAPI.TcPOU`](../examples/P_Demo_FB_SetLedColor_BAPI.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
