...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/35035403.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_TC_Stop.TcPOU`](../examples/P_Demo_TC_Stop.TcPOU) |
...
| `STOP` | `BOOL` | - | 输入布尔标志：`STOP`。具体语义见 §3 行为说明。 |
...
- 调用后 ADS 连接断；不能用同一 PLC 再发 TC_Restart 恢复（自己已停）。

## 6. 最小例程

> 配套可导入文件：[`examples/P_Demo_TC_Stop.TcPOU`](../examples/P_Demo_TC_Stop.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.87
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/35035403.html
- **相关 FB**：`TC_Restart`, `TC_Config`
