...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_Dpv1Read.xml`](../examples/P_Demo_FB_Dpv1Read.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_Dpv1Read.xml`](../examples/P_Demo_FB_Dpv1Read.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
