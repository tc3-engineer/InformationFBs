...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/9007199892812299.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_FB_CheckOemLicense.TcPOU`](../examples/P_Demo_FB_CheckOemLicense.TcPOU) |
...
| `stOemId` | `GUID` | - | 参数 `stOemId`（类型 `GUID`）。⚠️ PDF 未详述含义，请按 §3 行为说明使用。 |
...
> 配套可导入文件：[`examples/P_Demo_FB_CheckOemLicense.TcPOU`](../examples/P_Demo_FB_CheckOemLicense.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **场景**：OEM 设备出厂前签发 License 文件，开机校验防克隆。
- **价值**：OEM 防克隆标准方案。
- **替代方案对比**：
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.12
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/9007199892812299.html
- **相关 FB**：`FB_CheckLicense`, `FB_GetSystemId`
