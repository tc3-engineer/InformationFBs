...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/16287832459.html |
| Verified | 2026-06-03 ✅ |
| InfoSys-checked | ✅ 2026-06-03 |
| Status | `verified` |
| Example | [`examples/P_Demo_EIB_DATE_SEND_EX.TcPOU`](../examples/P_Demo_EIB_DATE_SEND_EX.TcPOU) |

---

## 1. 功能简述

`EIB_DATE_SEND` 的扩展版本：周期 / 变化 / 答查可调。替代固定 5 分钟节拍——适合需要更频繁或不定期发的场景。
...
| `wDay` | `WORD` | — | 日，1..31 |
| `wMonth` | `WORD` | — | 月，1..12 |
| `wYear` | `WORD` | — | 年，0..99；> 2000 时库自动减 2000 |
...
> 配套可导入文件：[`examples/P_Demo_EIB_DATE_SEND_EX.TcPOU`](../examples/P_Demo_EIB_DATE_SEND_EX.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf) §4.2.5.26
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/16287832459.html
- **相关**：`EIB_DATE_SEND`、`EIB_DATE_REC`
