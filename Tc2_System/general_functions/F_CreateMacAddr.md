...
| Status | `verified` |
| Example | [`examples/P_Demo_F_CreateMacAddr.xml`](../examples/P_Demo_F_CreateMacAddr.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_CreateMacAddr.xml`](../examples/P_Demo_F_CreateMacAddr.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
