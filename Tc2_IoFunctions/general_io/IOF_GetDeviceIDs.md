...
| Status | `verified` |
| Example | [`examples/P_Demo_IOF_GetDeviceIDs.xml`](../examples/P_Demo_IOF_GetDeviceIDs.xml) |
...
> 配套可导入文件：[`examples/P_Demo_IOF_GetDeviceIDs.xml`](../examples/P_Demo_IOF_GetDeviceIDs.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
