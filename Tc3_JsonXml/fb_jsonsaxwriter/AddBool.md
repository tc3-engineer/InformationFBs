...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_JsonSaxWriter_AddBool.TcPOU`](../examples/P_Demo_FB_JsonSaxWriter_AddBool.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_FB_JsonSaxWriter_AddBool.TcPOU`](../examples/P_Demo_FB_JsonSaxWriter_AddBool.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
>
...
- **PDF**：[`TwinCAT_3_PLC_Lib_Tc3_JsonXml_EN.pdf`](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc3_JsonXml_EN.pdf) §4.4.2
