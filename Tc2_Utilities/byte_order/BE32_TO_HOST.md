...
| Status | `verified` |
| Example | [`examples/P_Demo_BE32_TO_HOST.TcPOU`](../examples/P_Demo_BE32_TO_HOST.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_BE32_TO_HOST.TcPOU`](../examples/P_Demo_BE32_TO_HOST.TcPOU)
>
