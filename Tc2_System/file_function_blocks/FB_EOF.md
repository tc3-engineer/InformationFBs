...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_EOF.xml`](../examples/P_Demo_FB_EOF.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_EOF.xml`](../examples/P_Demo_FB_EOF.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
