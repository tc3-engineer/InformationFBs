...
**legacy → native 64-bit 无符号**：T_ULARGE_INTEGER → ULINT。
...
> 配套可导入文件：[`examples/P_Demo_ULARGE_TO_ULINT.xml`](../examples/P_Demo_ULARGE_TO_ULINT.xml)
>
