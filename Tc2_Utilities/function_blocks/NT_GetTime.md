...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/35037067.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_NT_GetTime.TcPOU`](../examples/P_Demo_NT_GetTime.TcPOU) |

---

## 1. 功能简述

NT_GetTime 通过 ADS 读取目标 TwinCAT 系统的**本机 Windows 系统时间**（任务栏时钟）。返回 `TIMESTRUCT` 含年月日时分秒毫秒，毫秒字段来自 Windows 而非 PLC 任务累加。
...
| `TIMESTR` | `TIMESTRUCT` | 输出的 Windows 系统时间（`TIMESTRUCT`）。 |
...
> 配套可导入文件：[`examples/P_Demo_NT_GetTime.TcPOU`](../examples/P_Demo_NT_GetTime.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.66
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/35037067.html
- **相关 FB**：`NT_SetLocalTime`, `FB_LocalSystemTime`, `RTC_EX2`
