...
| Example | [`examples/P_Demo_GETSYSTEMTIME.xml`](../examples/P_Demo_GETSYSTEMTIME.xml) |
...
> 配套可导入文件：[`examples/P_Demo_GETSYSTEMTIME.xml`](../examples/P_Demo_GETSYSTEMTIME.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
