...
| Status | `verified` |
| Example | [`examples/P_Demo_BYTE_TO_BINSTR.xml`](../examples/P_Demo_BYTE_TO_BINSTR.xml) |
...
> 配套可导入文件：[`examples/P_Demo_BYTE_TO_BINSTR.xml`](../examples/P_Demo_BYTE_TO_BINSTR.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
