...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_GetDongleSystemID.xml`](../examples/P_Demo_FB_GetDongleSystemID.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_GetDongleSystemID.xml`](../examples/P_Demo_FB_GetDongleSystemID.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
