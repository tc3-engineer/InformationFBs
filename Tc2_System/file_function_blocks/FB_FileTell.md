...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_FileTell.xml`](../examples/P_Demo_FB_FileTell.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_FileTell.xml`](../examples/P_Demo_FB_FileTell.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
