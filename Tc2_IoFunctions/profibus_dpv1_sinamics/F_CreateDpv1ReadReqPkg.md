...
| Status | `verified` |
| Example | [`examples/P_Demo_F_CreateDpv1ReadReqPkg.TcPOU`](../examples/P_Demo_F_CreateDpv1ReadReqPkg.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_F_CreateDpv1ReadReqPkg.TcPOU`](../examples/P_Demo_F_CreateDpv1ReadReqPkg.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
>
