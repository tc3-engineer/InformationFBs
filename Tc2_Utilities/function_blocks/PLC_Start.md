...
| Status | `verified` |
| Example | [`examples/P_Demo_PLC_Start.xml`](../examples/P_Demo_PLC_Start.xml) |
...
> 配套可导入文件：[`examples/P_Demo_PLC_Start.xml`](../examples/P_Demo_PLC_Start.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
