...
| Status | `verified` |
| Example | [`examples/P_Demo_MC_StepLimitSwitch.TcPOU`](../examples/P_Demo_MC_StepLimitSwitch.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_MC_StepLimitSwitch.TcPOU`](../examples/P_Demo_MC_StepLimitSwitch.TcPOU)
