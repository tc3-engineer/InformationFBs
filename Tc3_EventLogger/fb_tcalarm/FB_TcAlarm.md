...
This function block represents an alarm of the TwinCAT 3 EventLogger. Syntax Definition: FUNCTION_BLOCK FB_TcAlarm EXTENDS FB_TcEventBase Inheritance hierarchy FB_TcEventBase [ }   71 ] FB_TcAlarm
...
> 配套可导入文件：[`examples/P_Demo_FB_TcAlarm.xml`](../examples/P_Demo_FB_TcAlarm.xml)
>
> 详见 [`examples/README.md`](../examples/README.md)

```iecst
PROGRAM P_Demo_FB_TcAlarm
VAR
    fbFB_TcAlarm : FB_TcAlarm;
END_VAR
