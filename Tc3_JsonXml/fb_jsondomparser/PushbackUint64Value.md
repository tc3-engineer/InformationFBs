...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_JsonDomParser_PushbackUint64Value.TcPOU`](../examples/P_Demo_FB_JsonDomParser_PushbackUint64Value.TcPOU) |

---

## 1. 功能简述

在 JSON 数组末尾追加一个 Uint64 类型的元素值。返回新元素的 `SJsonValue` 句柄。
...
> 配套可导入文件：[`examples/P_Demo_FB_JsonDomParser_PushbackUint64Value.TcPOU`](../examples/P_Demo_FB_JsonDomParser_PushbackUint64Value.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
>
...
- **PDF**：[`TwinCAT_3_PLC_Lib_Tc3_JsonXml_EN.pdf`](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc3_JsonXml_EN.pdf) §4.1.89
