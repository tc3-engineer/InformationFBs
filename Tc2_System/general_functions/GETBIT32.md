...
| Status | `verified` |
| Example | [`examples/P_Demo_GETBIT32.xml`](../examples/P_Demo_GETBIT32.xml) |
...
> 配套可导入文件：[`examples/P_Demo_GETBIT32.xml`](../examples/P_Demo_GETBIT32.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
