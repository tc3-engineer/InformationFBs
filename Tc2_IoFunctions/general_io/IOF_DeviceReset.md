...
| Status | `verified` |
| Example | [`examples/P_Demo_IOF_DeviceReset.xml`](../examples/P_Demo_IOF_DeviceReset.xml) |
...
> 配套可导入文件：[`examples/P_Demo_IOF_DeviceReset.xml`](../examples/P_Demo_IOF_DeviceReset.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
