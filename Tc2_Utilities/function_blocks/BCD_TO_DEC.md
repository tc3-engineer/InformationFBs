...
| Status | `verified` |
| Example | [`examples/P_Demo_BCD_TO_DEC.TcPOU`](../examples/P_Demo_BCD_TO_DEC.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_BCD_TO_DEC.TcPOU`](../examples/P_Demo_BCD_TO_DEC.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
