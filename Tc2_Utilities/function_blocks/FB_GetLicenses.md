...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/34999691.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_FB_GetLicenses.TcPOU`](../examples/P_Demo_FB_GetLicenses.TcPOU) |
...
| `aValidLicenses` | `ARRAY [1..nMaxLicenses] OF ST_TcOnlineLicenseInfoData` | 参数 `aValidLicenses`（类型 `ARRAY [1..nMaxLicenses] OF ST_TcOnlineLicenseInfoData`）。⚠️ PDF 未详述含义，请按 §3 行为说明使用。 |
| `nInvalidLicenses` | `UDINT` | 无符号整数输出：`nInvalidLicenses`。 |
| `aInvalidLicenses` | `ARRAY [1..nMaxLicenses] OF ST_TcOnlineLicenseInfoData` | 参数 `aInvalidLicenses`（类型 `ARRAY [1..nMaxLicenses] OF ST_TcOnlineLicenseInfoData`）。⚠️ PDF 未详述含义，请按 §3 行为说明使用。 |
...
> 配套可导入文件：[`examples/P_Demo_FB_GetLicenses.TcPOU`](../examples/P_Demo_FB_GetLicenses.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.31
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/34999691.html
- **相关 FB**：`FB_GetLicensesEx`, `FB_CheckLicense`
