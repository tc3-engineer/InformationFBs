...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_SoEAX5000FirmwareUpdate_ByDriveRef.xml`](../examples/P_Demo_FB_SoEAX5000FirmwareUpdate_ByDriveRef.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_SoEAX5000FirmwareUpdate_ByDriveRef.xml`](../examples/P_Demo_FB_SoEAX5000FirmwareUpdate_ByDriveRef.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
