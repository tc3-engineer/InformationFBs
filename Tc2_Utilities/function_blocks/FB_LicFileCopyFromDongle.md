...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_LicFileCopyFromDongle.xml`](../examples/P_Demo_FB_LicFileCopyFromDongle.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_LicFileCopyFromDongle.xml`](../examples/P_Demo_FB_LicFileCopyFromDongle.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
