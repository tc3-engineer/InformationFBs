...
| Status | `verified` |
| Example | [`examples/P_Demo_IOF_LB_ParityCheck.xml`](../examples/P_Demo_IOF_LB_ParityCheck.xml) |
...
> 配套可导入文件：[`examples/P_Demo_IOF_LB_ParityCheck.xml`](../examples/P_Demo_IOF_LB_ParityCheck.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
