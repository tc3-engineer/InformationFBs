...
| Status | `verified` |
| Example | [`examples/P_Demo_CLEARBIT32.xml`](../examples/P_Demo_CLEARBIT32.xml) |
...
> 配套可导入文件：[`examples/P_Demo_CLEARBIT32.xml`](../examples/P_Demo_CLEARBIT32.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
