...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/187766539.html |
| Verified | 2026-06-03 ✅ |
| InfoSys-checked | ✅ 2026-06-03 |
| Status | `verified` |
| Example | [`examples/P_Demo_EIB_4OCTET_SIGN_SEND_EX.TcPOU`](../examples/P_Demo_EIB_4OCTET_SIGN_SEND_EX.TcPOU) |

---

## 1. 功能简述

**`EIB_4OCTET_SIGN_SEND` 的扩展版本**：发送 DPT 13.xxx (4-byte signed int) telegram，支持 Manual / Polling / OnChange / OnChangePolling 4 种模式。
...
| `uiData` | `DINT` | — | 数据值（IEC `DINT`），库编码为 EIB 4 byte signed（DPT 13.xxx）。**PDF VAR_INPUT 引脚名为 `uiData`**（u 前缀本意是 unsigned，但类型是 signed `DINT`——PDF 排版错；按 PDF 逐字保留） |
...
> 配套可导入文件：[`examples/P_Demo_EIB_4OCTET_SIGN_SEND_EX.TcPOU`](../examples/P_Demo_EIB_4OCTET_SIGN_SEND_EX.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf) §4.2.5.12
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/187766539.html
- **相关**：`EIB_4OCTET_SIGN_SEND`（§4.2.5.11）、`EIB_4OCTET_SIGN_REC`
