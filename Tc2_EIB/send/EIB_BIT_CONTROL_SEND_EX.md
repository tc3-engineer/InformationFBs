...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/16287830155.html |
| Verified | 2026-06-03 ✅ |
| InfoSys-checked | ✅ 2026-06-03 |
| Status | `verified` |
| Example | [`examples/P_Demo_EIB_BIT_CONTROL_SEND_EX.TcPOU`](../examples/P_Demo_EIB_BIT_CONTROL_SEND_EX.TcPOU) |

---

## 1. 功能简述

`EIB_BIT_CONTROL_SEND` 的扩展版本：支持 4 种模式 + 响应 read。DPT 2.xxx 复杂场景（应急覆盖 + BMS 主动查询）首选。
...
> 配套可导入文件：[`examples/P_Demo_EIB_BIT_CONTROL_SEND_EX.TcPOU`](../examples/P_Demo_EIB_BIT_CONTROL_SEND_EX.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf) §4.2.5.21
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/16287830155.html
- **相关**：`EIB_BIT_CONTROL_SEND`（§4.2.5.20）、`EIB_BIT_CONTROL_REC`
