...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_ResetTaskExceedCounter.xml`](../examples/P_Demo_FB_ResetTaskExceedCounter.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_ResetTaskExceedCounter.xml`](../examples/P_Demo_FB_ResetTaskExceedCounter.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
