...
> 配套可导入文件：[`examples/P_Demo_FB_CheckLicense.xml`](../examples/P_Demo_FB_CheckLicense.xml)
>
> 详见 [`examples/README.md`](../examples/README.md)

```iecst
PROGRAM P_Demo_FB_CheckLicense
VAR
    fbFB_CheckLicense : FB_CheckLicense;
    arg_bExecute : BOOL;
    arg_tTimeout : TIME;
