...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_FileRename.xml`](../examples/P_Demo_FB_FileRename.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_FileRename.xml`](../examples/P_Demo_FB_FileRename.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
