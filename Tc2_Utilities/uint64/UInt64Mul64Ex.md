...
| Verified | 2026-05-10 ✅ |
| Status | `verified` |
| Example | [`examples/P_Demo_UInt64Mul64Ex.xml`](../examples/P_Demo_UInt64Mul64Ex.xml) |
...
> 配套可导入文件：[`examples/P_Demo_UInt64Mul64Ex.xml`](../examples/P_Demo_UInt64Mul64Ex.xml)
>
...
a := ULARGE_INTEGER(16#FFFFFFFF, 16#FFFFFFFF); b := ULARGE_INTEGER(0, 2);
IF bRun THEN
    rResult := UInt64Mul64Ex(multiplicand := a, multiplier := b, bOV := bOV);
    bRun := FALSE;
END_IF;
```
