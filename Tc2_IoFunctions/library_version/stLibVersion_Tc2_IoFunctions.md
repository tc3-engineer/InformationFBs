...
| Status | `verified` |
| Example | [`examples/P_Demo_stLibVersion_Tc2_IoFunctions.xml`](../examples/P_Demo_stLibVersion_Tc2_IoFunctions.xml) |
...
> 配套可导入文件：[`examples/P_Demo_stLibVersion_Tc2_IoFunctions.xml`](../examples/P_Demo_stLibVersion_Tc2_IoFunctions.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
