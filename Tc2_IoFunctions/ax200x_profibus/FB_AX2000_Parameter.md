...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_AX2000_Parameter.xml`](../examples/P_Demo_FB_AX2000_Parameter.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_AX2000_Parameter.xml`](../examples/P_Demo_FB_AX2000_Parameter.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
