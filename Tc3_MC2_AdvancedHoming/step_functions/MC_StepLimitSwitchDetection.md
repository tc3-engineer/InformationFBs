...
| Status | `verified` |
| Example | [`examples/P_Demo_MC_StepLimitSwitchDetection.xml`](../examples/P_Demo_MC_StepLimitSwitchDetection.xml) |
...
> 配套可导入文件：[`examples/P_Demo_MC_StepLimitSwitchDetection.xml`](../examples/P_Demo_MC_StepLimitSwitchDetection.xml)
