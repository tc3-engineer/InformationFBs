...
| Status | `verified` |
| Example | [`examples/P_Demo_IOF_SER_IDN_Read.xml`](../examples/P_Demo_IOF_SER_IDN_Read.xml) |
...
> 配套可导入文件：[`examples/P_Demo_IOF_SER_IDN_Read.xml`](../examples/P_Demo_IOF_SER_IDN_Read.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
