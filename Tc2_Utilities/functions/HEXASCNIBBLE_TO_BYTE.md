...
| Status | `verified` |
| Example | [`examples/P_Demo_HEXASCNIBBLE_TO_BYTE.TcPOU`](../examples/P_Demo_HEXASCNIBBLE_TO_BYTE.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_HEXASCNIBBLE_TO_BYTE.TcPOU`](../examples/P_Demo_HEXASCNIBBLE_TO_BYTE.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
>
