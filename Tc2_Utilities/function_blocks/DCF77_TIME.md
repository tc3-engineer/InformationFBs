...
| Status | `verified` |
| Example | [`examples/P_Demo_DCF77_TIME.TcPOU`](../examples/P_Demo_DCF77_TIME.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_DCF77_TIME.TcPOU`](../examples/P_Demo_DCF77_TIME.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
