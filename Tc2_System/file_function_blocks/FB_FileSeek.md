...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_FileSeek.xml`](../examples/P_Demo_FB_FileSeek.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_FileSeek.xml`](../examples/P_Demo_FB_FileSeek.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
