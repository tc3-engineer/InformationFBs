...
`FB_S_UPS_CX9020_U900` 用于 **CX9020-U900** 平台带 1-second UPS 设备从 PLC 控制 UPS。断电时根据 `eUpsMode` 决定保存持久化数据或/和执行 quick shutdown。**默认输入值不应改动**。
...
VAR
    fbFB_S_UPS_CX9020_U900 : FB_S_UPS_CX9020_U900;
