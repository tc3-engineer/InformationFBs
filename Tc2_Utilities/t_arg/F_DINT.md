...
| Status | `verified` |
| Example | [`examples/P_Demo_F_DINT.xml`](../examples/P_Demo_F_DINT.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_DINT.xml`](../examples/P_Demo_F_DINT.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
