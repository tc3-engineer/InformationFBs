...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/187771147.html |
| Verified | 2026-06-03 ✅ |
| InfoSys-checked | ✅ 2026-06-03 |
| Status | `verified` |
| Example | [`examples/P_Demo_EIB_8BIT_SIGN_SEND_EX.TcPOU`](../examples/P_Demo_EIB_8BIT_SIGN_SEND_EX.TcPOU) |

---

## 1. 功能简述

`EIB_8BIT_SIGN_SEND` 的扩展版本：支持 Manual / Polling / OnChange / OnChangePolling 4 种模式 + 响应 Read。DPT 5.001/5.003/5.005 缩放可选。
...
| 名称 | 类型 | 默认值 | 说明 |
|---|---|---|---|
| `bStart` | `BOOL` | — | FB 触发，上升沿 |
| `iMode` | `INT` | — | 0/1/2/3 = Manual/Polling/OnChange/OnChangePolling |
| `CyclePolling` | `TIME` | `t#500ms` | Polling 周期，下限 200 ms |
| `iData` | `INT` | — | 数据值，范围依 `Scaling_Mode` |
| `Scaling_Mode` | `INT` | — | 0 = 0..100% / 1 = 0..360° / 2 = 0..255 |
...
> 配套可导入文件：[`examples/P_Demo_EIB_8BIT_SIGN_SEND_EX.TcPOU`](../examples/P_Demo_EIB_8BIT_SIGN_SEND_EX.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf) §4.2.5.16
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/187771147.html
- **相关**：`EIB_8BIT_SIGN_SEND`（§4.2.5.15）、`EIB_8BIT_SIGN_REC`
