...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/34978827.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_FB_CSVMemBufferReader.TcPOU`](../examples/P_Demo_FB_CSVMemBufferReader.TcPOU) |
...
| `cbValue` | `UDINT` | `0` | 无符号整数输出：`cbValue`。 |
| `bCRLF` | `BOOL` | `FALSE` | 输出布尔标志：`bCRLF`。具体语义见 §3 行为说明。 |
| `cbRead` | `UDINT` | `0` | 无符号整数输出：`cbRead`。 |
...
> 配套可导入文件：[`examples/P_Demo_FB_CSVMemBufferReader.TcPOU`](../examples/P_Demo_FB_CSVMemBufferReader.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.13
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/34978827.html
