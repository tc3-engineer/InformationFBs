...
| Status | `verified` |
| Example | [`examples/P_Demo_F_GetStructMemberAlignment.xml`](../examples/P_Demo_F_GetStructMemberAlignment.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_GetStructMemberAlignment.xml`](../examples/P_Demo_F_GetStructMemberAlignment.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
