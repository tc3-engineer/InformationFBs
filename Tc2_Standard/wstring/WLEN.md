...
| Source | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_standard/wlen.html |
...
**WSTRING 版本**：返回 WSTRING 长度。 与 `LEN` 同语义，但操作 `WSTRING`（双字节字符）。
