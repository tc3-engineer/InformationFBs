...
- 见上方功能简述。
- 详细行为（时序、错误码、状态机）请对照 PDF 第 3.88 节。
...
- 描述句、时序行为、错误码表等细节请以 PDF 第 3.88 节为准（⚠️ 待人工细化）。

## 6. 最小例程

> 配套可导入文件：[`examples/P_Demo_TC_SysLatency.xml`](../examples/P_Demo_TC_SysLatency.xml)
>
> 详见 [`examples/README.md`](../examples/README.md)

```iecst
PROGRAM P_Demo_TC_SysLatency
VAR
