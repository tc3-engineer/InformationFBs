...
| Status | `verified` |
| Example | [`examples/P_Demo_F_GetVersionTcIoFunctions.xml`](../examples/P_Demo_F_GetVersionTcIoFunctions.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_GetVersionTcIoFunctions.xml`](../examples/P_Demo_F_GetVersionTcIoFunctions.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
