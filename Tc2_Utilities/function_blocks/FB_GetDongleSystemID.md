...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/9007199892815499.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_FB_GetDongleSystemID.TcPOU`](../examples/P_Demo_FB_GetDongleSystemID.TcPOU) |
...
| `stAmsAddr` | `AMSADDR` | 参数 `stAmsAddr`（类型 `AMSADDR`）。⚠️ PDF 未详述含义，请按 §3 行为说明使用。 |
...
> 配套可导入文件：[`examples/P_Demo_FB_GetDongleSystemID.TcPOU`](../examples/P_Demo_FB_GetDongleSystemID.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **场景**：OEM License 绑定 dongle SystemID。
- **价值**：跨 OS 重装稳定的硬件指纹。
- **替代方案对比**：
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.27
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/9007199892815499.html
- **相关 FB**：`FB_GetLicenseDongles`
