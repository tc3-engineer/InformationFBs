...
| Verified | 2026-05-10 ✅ |
| Status | `verified` |
| Example | [`examples/P_Demo_UInt64Mod64.xml`](../examples/P_Demo_UInt64Mod64.xml) |

---
## 1. 功能简述

**T_ULARGE_INTEGER 取模**：返回余数。
...
> 配套可导入文件：[`examples/P_Demo_UInt64Mod64.xml`](../examples/P_Demo_UInt64Mod64.xml)
>
