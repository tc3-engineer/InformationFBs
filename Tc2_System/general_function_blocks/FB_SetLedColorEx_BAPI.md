...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_SetLedColorEx_BAPI.xml`](../examples/P_Demo_FB_SetLedColorEx_BAPI.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_SetLedColorEx_BAPI.xml`](../examples/P_Demo_FB_SetLedColorEx_BAPI.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
