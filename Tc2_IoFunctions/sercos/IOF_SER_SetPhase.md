...
| Status | `verified` |
| Example | [`examples/P_Demo_IOF_SER_SetPhase.xml`](../examples/P_Demo_IOF_SER_SetPhase.xml) |
...
> 配套可导入文件：[`examples/P_Demo_IOF_SER_SetPhase.xml`](../examples/P_Demo_IOF_SER_SetPhase.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
