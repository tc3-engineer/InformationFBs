...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/187755787.html |
| Verified | 2026-06-03 ✅ |
| InfoSys-checked | ✅ 2026-06-03 |
| Status | `verified` |
| Example | [`examples/P_Demo_EIB_2OCTET_FLOAT_SEND_EX.TcPOU`](../examples/P_Demo_EIB_2OCTET_FLOAT_SEND_EX.TcPOU) |

---

## 1. 功能简述

**`EIB_2OCTET_FLOAT_SEND` 的扩展版本**：发送 DPT 9.xxx (2-byte float, 半精度) telegram，支持 Manual / Polling / OnChange / OnChangePolling 4 种模式。
...
| `rData` | `REAL` | — | 数据值（IEC `REAL`），库自动转成 EIB 2 byte float（DPT 9.xxx 半精度） |
...
> 配套可导入文件：[`examples/P_Demo_EIB_2OCTET_FLOAT_SEND_EX.TcPOU`](../examples/P_Demo_EIB_2OCTET_FLOAT_SEND_EX.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
...
- **场景**：PLC 测量值定时心跳 + 即时变化 + 响应主动查询
- **价值**：比普通 FB 强大得多；BMS 实际项目首选
- **替代方案对比**：
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_EIB_EN.pdf) §4.2.5.2
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_eib/187755787.html
- **相关**：`EIB_2OCTET_FLOAT_SEND`（同库 §4.2.5.1，简化版）、`EIB_2OCTET_FLOAT_REC`
