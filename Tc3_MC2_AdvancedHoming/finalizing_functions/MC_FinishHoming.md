...
| Status | `verified` |
| Example | [`examples/P_Demo_MC_FinishHoming.xml`](../examples/P_Demo_MC_FinishHoming.xml) |
...
> 配套可导入文件：[`examples/P_Demo_MC_FinishHoming.xml`](../examples/P_Demo_MC_FinishHoming.xml)
