...
| Status | `verified` |
| Example | [`examples/P_Demo_F_ULARGE.xml`](../examples/P_Demo_F_ULARGE.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_ULARGE.xml`](../examples/P_Demo_F_ULARGE.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
