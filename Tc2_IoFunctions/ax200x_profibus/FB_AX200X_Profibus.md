...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_AX200X_Profibus.xml`](../examples/P_Demo_FB_AX200X_Profibus.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_AX200X_Profibus.xml`](../examples/P_Demo_FB_AX200X_Profibus.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
