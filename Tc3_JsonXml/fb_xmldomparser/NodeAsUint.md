...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_XmlDomParser_NodeAsUint.TcPOU`](../examples/P_Demo_FB_XmlDomParser_NodeAsUint.TcPOU) |

---

## 1. 功能简述

把 XML 节点的文本内容解析为 PLC `Uint` 类型并返回。
...
> 配套可导入文件：[`examples/P_Demo_FB_XmlDomParser_NodeAsUint.TcPOU`](../examples/P_Demo_FB_XmlDomParser_NodeAsUint.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）
>
...
- **PDF**：[`TwinCAT_3_PLC_Lib_Tc3_JsonXml_EN.pdf`](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc3_JsonXml_EN.pdf) §4.7.72
