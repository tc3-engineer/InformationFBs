...
| Status | `verified` |
| Example | [`examples/P_Demo_FB_RAIDFindCntlr.xml`](../examples/P_Demo_FB_RAIDFindCntlr.xml) |
...
> 配套可导入文件：[`examples/P_Demo_FB_RAIDFindCntlr.xml`](../examples/P_Demo_FB_RAIDFindCntlr.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
