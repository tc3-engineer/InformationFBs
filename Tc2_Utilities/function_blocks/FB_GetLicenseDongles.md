...
| Source InfoSys | https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/9007199892814347.html |
| Verified | 2026-05-11 ✅ |
| InfoSys-checked | ✅ 2026-05-11 |
| Status | `verified` |
| Example | [`examples/P_Demo_FB_GetLicenseDongles.TcPOU`](../examples/P_Demo_FB_GetLicenseDongles.TcPOU) |
...
| `nLicenseDeviceDongles` | `UDINT` | 无符号整数输出：`nLicenseDeviceDongles`。 |
| `aLicenseDeviceDongles` | `ARRAY[1..nMaxLicenseDevices] OF ST_LicenseDongle` | 参数 `aLicenseDeviceDongles`（类型 `ARRAY[1..nMaxLicenseDevices] OF ST_LicenseDongle`）。⚠️ PDF 未详述含义，请按 §3 行为说明使用。 |
...
> 配套可导入文件：[`examples/P_Demo_FB_GetLicenseDongles.TcPOU`](../examples/P_Demo_FB_GetLicenseDongles.TcPOU)（TwinCAT 3 原生 .TcPOU，可直接拖入 XAE 的 PLC POUs 文件夹）。
>
...
- **PDF**：[TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf](https://download.beckhoff.com/download/document/automation/twincat3/TwinCAT_3_PLC_Lib_Tc2_Utilities_EN.pdf) §3.30
- **InfoSys topic**：https://infosys.beckhoff.com/content/1033/tcplclib_tc2_utilities/9007199892814347.html
- **相关 FB**：`FB_GetDongleSystemID`
