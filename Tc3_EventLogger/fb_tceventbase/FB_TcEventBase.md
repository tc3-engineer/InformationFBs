...
This function block contains the basic implementation. Syntax Definition: FUNCTION_BLOCK FB_TcEventBase
...
> 配套可导入文件：[`examples/P_Demo_FB_TcEventBase.xml`](../examples/P_Demo_FB_TcEventBase.xml)
>
> 详见 [`examples/README.md`](../examples/README.md)

```iecst
PROGRAM P_Demo_FB_TcEventBase
VAR
    fbFB_TcEventBase : FB_TcEventBase;
END_VAR
