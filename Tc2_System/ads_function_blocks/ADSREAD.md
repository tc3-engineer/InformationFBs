...
| Status | `verified` |
| Example | [`examples/P_Demo_ADSREAD.xml`](../examples/P_Demo_ADSREAD.xml) |
...
> 配套可导入文件：[`examples/P_Demo_ADSREAD.xml`](../examples/P_Demo_ADSREAD.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）。
>
