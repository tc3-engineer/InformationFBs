...
| Status | `verified` |
| Example | [`examples/P_Demo_F_GetDOYOfYearMonthDay.TcPOU`](../examples/P_Demo_F_GetDOYOfYearMonthDay.TcPOU) |
...
> 配套可导入文件：[`examples/P_Demo_F_GetDOYOfYearMonthDay.TcPOU`](../examples/P_Demo_F_GetDOYOfYearMonthDay.TcPOU)
>
