...
| Status | `verified` |
| Example | [`examples/P_Demo_F_SINT.xml`](../examples/P_Demo_F_SINT.xml) |
...
> 配套可导入文件：[`examples/P_Demo_F_SINT.xml`](../examples/P_Demo_F_SINT.xml)（PLCopenXML，可直接导入 TwinCAT 3 XAE）
>
